<section class="cabecera">
	...
	<nav aria-label="breadcrumb" class="bread">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a href="/sostenibilidad">Sostenibilidad</a></li>
			<li class="breadcrumb-item"><a href="/sostenibilidad/academia">Academia</a></li>
			<li class="breadcrumb-item active" aria-current="page">Toma la sartén por el margo</li>
		</ol>
	</nav>
</section>
