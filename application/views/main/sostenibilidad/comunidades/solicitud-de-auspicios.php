<section class="cabecera">
	...
	<nav aria-label="breadcrumb" class="bread">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a href="/sostenibilidad/comunidades">Comunidades</a></li>
			<li class="breadcrumb-item active" aria-current="page">Solicitud de auspicios</li>
		</ol>
	</nav>
</section>
