<section class="cabecera">
	...
	<nav aria-label="breadcrumb" class="bread">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a href="/sostenibilidad/plan-de-sostenibilidad">Plan de Sostenibilidad</a></li>
			<li class="breadcrumb-item active" aria-current="page">Adaptación/mitigación</li>
		</ol>
	</nav>
</section>
