<section class="cabecera">
	...
	<nav aria-label="breadcrumb" class="bread">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a href="/sostenibilidad/compromiso">Compromiso</a></li>
			<li class="breadcrumb-item active" aria-current="page">Política de sostenibilidad</li>
		</ol>
	</nav>
</section>
