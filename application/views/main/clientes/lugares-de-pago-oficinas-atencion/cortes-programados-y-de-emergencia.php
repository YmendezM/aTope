<section class="cabecera">
		...
		<div class="row">
			<div class="col-12">
				<h1 class="blanco text-center my-0 mb-xl-5">
					Cortes programados y de emergencia
				</h1>
			</div>
		</div>
	...
	<nav aria-label="breadcrumb" class="bread">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a href="/clientes/lugares-de-pago-oficinas-atencion">Lugares de Pago y Oficinas de Atención</a></li>
			<li class="breadcrumb-item active" aria-current="page">Cortes programados y de emergencia</li>
		</ol>
	</nav>
</section>
