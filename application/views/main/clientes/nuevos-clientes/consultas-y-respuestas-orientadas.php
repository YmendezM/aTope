<section class="cabecera">
		...
		<div class="row">
			<div class="col-12">
				<h1 class="blanco text-center my-0 mb-xl-5">
					Consultas y respuestas orientadas
				</h1>
			</div>
		</div>
	...
	<nav aria-label="breadcrumb" class="bread">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a href="/clientes/nuevos-clientes">Nuevos Clientes</a></li>
			<li class="breadcrumb-item active" aria-current="page">Consultas y respuestas orientadas</li>
		</ol>
	</nav>
</section>
