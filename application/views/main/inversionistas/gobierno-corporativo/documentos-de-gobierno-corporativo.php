<section class="cabecera">
	...
	<nav aria-label="breadcrumb" class="bread">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a href="/inversionistas/gobierno-corporativo">Gobierno Corporativo</a></li>
			<li class="breadcrumb-item active" aria-current="page">Documentos de gobierno corporativo</li>
		</ol>
	</nav>
</section>
