<section class="cabecera">
	...
	<nav aria-label="breadcrumb" class="bread">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a href="/inversionistas/accionistas">Accionistas</a></li>
			<li class="breadcrumb-item active" aria-current="page">Registro de accionistas</li>
		</ol>
	</nav>
</section>
