<section class="cabecera">
		...
		<div class="row">
			<div class="col-12">
				<h1 class="blanco text-center my-0 mb-xl-5">
					Oportunidades laborales, prácticas y memorias
				</h1>
			</div>
		</div>
	...
	<nav aria-label="breadcrumb" class="bread">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a href="/nosotros/trabaja-con-nosotros">Trabaja con nosotros</a></li>
			<li class="breadcrumb-item active" aria-current="page">Oportunidades laborales, prácticas y memorias</li>
		</ol>
	</nav>
</section>
