<section class="cabecera">
	...
	<nav aria-label="breadcrumb" class="bread">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a href="/nosotros/etica-y-transparencia">Ética y Transparencia</a></li>
			<li class="breadcrumb-item active" aria-current="page">Sistema prevención de delitos</li>
		</ol>
	</nav>
</section>
