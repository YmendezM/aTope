<section class="cabecera">
	...
	<nav aria-label="breadcrumb" class="bread">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a href="/nosotros/somos">Somos <?php echo $empresa; ?></a></li>
			<li class="breadcrumb-item active" aria-current="page">Principios inspiradores</li>
		</ol>
	</nav>
</section>
